...
$result = $con->query("SELECT COUNT(*) AS count FROM holdingcage");
$row = $result->fetch_assoc();
$holdingCount = $row['count'];

$result = $con->query("SELECT COUNT(*) AS count FROM matingcage");
$row = $result->fetch_assoc();
        ...
        <div class="row">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active d-flex align-items-center" aria-current="page"
                                href="adminlanding.php">
                                <i class="fas fa-tachometer-alt nav-icons"></i>
                                <span>Admin Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center" href="aaeinternal.php">
                                <i class="fas fa-user-check nav-icons"></i>
                                Approve EA Students
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center" href="EA_students.php">
                                <i class="fas fa-user-times nav-icons"></i>
                                Drop/View EA Users
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center" href="definefilter.php">
                                <i class="fas fa-filter nav-icons"></i>
                                Filter
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Welcome, <?php echo $_SESSION['admin_username']; ?></h1>
                </div>
...
<iframe src="https://sensor.sathyanesanlab-iot.work/d-solo/e5cd9da9-01e9-4e72-b022-a8c39ba0a1e5/sht31-sensor-data?orgId=1&from=now-6h&to=now&refresh=5s&theme=light&panelId=2" width="450" height="300" frameborder="0"></iframe>
<iframe src="https://sensor.sathyanesanlab-iot.work/d-solo/e5cd9da9-01e9-4e72-b022-a8c39ba0a1e5/sht31-sensor-data?orgId=1&from=now-6h&to=now&refresh=5s&theme=light&panelId=1" width="450" height="300" frameborder="0"></iframe>
