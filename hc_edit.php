                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    ...
                                    while ($file = $files->fetch_assoc()) {
                                        ...
                                        echo "<a href='delete_file.php?url=hc_edit&id=$file_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this file?\");' aria-label='Delete $file_name'> <i class='fas fa-trash fa-xs'></i></a><br>";
                                    }
                                    ?>
                                </div>
